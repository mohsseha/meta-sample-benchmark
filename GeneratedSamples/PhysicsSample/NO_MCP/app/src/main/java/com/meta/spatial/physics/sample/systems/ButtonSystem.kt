...
import com.meta.spatial.physics.sample.components.ButtonComponent
...
class ButtonSystem : System() {
    ...
    override fun onStart() {
        query = QueryBuilder()
            .require(ButtonComponent::class.java)
    ...
    override fun onUpdate(context: UpdateContext) {
        query.forEach { entity ->
            ...
            // For this sample, we'll just apply a force to simulate a press.
